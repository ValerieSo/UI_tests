...
class TestLogin:
    ...
    def test_login_by_click_on_login_button_on_main_success(self, driver, registration):
    ...
    def test_login_from_personal_account_success(self, driver, registration):
        # предусловие: переход на главную страницу после регистрации
        login_value, pwd_value = registration
        driver.get("https://stellarburgers.nomoreparties.site/")
        #шаги
    ...
    def test_login_registration_form_sign_in_button_success(self, driver, registration):
        # предусловие: переход на главную страницу после регистрации
        login_value, pwd_value = registration
        driver.get("https://stellarburgers.nomoreparties.site/")
        # шаги
    ...
    def test_login_button_on_the_password_recovery_form_success(self, driver, registration):
        # предусловие: переход на главную страницу после регистрации
        login_value, pwd_value = registration
        driver.get("https://stellarburgers.nomoreparties.site/")
        # шаги
